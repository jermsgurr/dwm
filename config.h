...
static const char *fonts[]          = { "monospace:size=9", "JoyPixels:pixelsize=9:antialias=false:autohint=true"  };
...
static Key keys[] = {
	...
	{ MODKEY|ShiftMask,		XK_a,		spawn,		SHCMD("st -e ranger") },
	{ MODKEY|ShiftMask,		XK_c,		spawn,		SHCMD("brave") },
